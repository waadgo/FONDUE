...
from .conform import is_conform, conform, check_affine_in_nifti, std_pos, conform_std, conform_mask, conform_std_mask, conform_keep_dims
...
def load_and_conform_image(img_filename, interpol=1, logger=None, is_eval = False, conform_type = 0):
    """
...
def load_and_keep_dims(img_filename, interpol=1, logger=None, is_eval = False, conform_type = 0):
    """
    Function to load MRI image and conform it to UCHAR, RAS orientation and 1mm isotropic voxels size
    (if it does not already have this format)
    :param str img_filename: path and name of volume to read
    ...
    orig = conform_keep_dims(orig, interpol)
