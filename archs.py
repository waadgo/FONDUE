...
class UNet(nn.Module):
    def __init__(self, num_classes, input_channels=3, **kwargs):
        ...
        nb_filter = [128, 128, 128, 128, 128]

        self.pool = nn.MaxPool2d(2, 2)
        self.up = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True)

        self.conv0_0 = VGGBlockInput(input_channels, nb_filter[0], nb_filter[0])
...
class DCCRNet(nn.Module):
    def __init__(self, num_classes, input_channels=7, deep_supervision=False, **kwargs):
        ...
        self.conv0_0 = VGGBlockInput(input_channels, nb_filter, nb_filter)
        self.conv1_0 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv2_0 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv3_0 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv4_0 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv5_0 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv6_0 = VGGBlock(nb_filter, nb_filter, nb_filter)

        self.conv0_1 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv1_1 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv2_1 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv3_1 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv4_1 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv5_1 = VGGBlock(nb_filter, nb_filter, nb_filter)

        self.conv0_2 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv1_2 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv2_2 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv3_2 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv4_2 = VGGBlock(nb_filter, nb_filter, nb_filter)

        self.conv0_3 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv1_3 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv2_3 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv3_3 = VGGBlock(nb_filter, nb_filter, nb_filter)

        self.conv0_4 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv1_4 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv2_4 = VGGBlock(nb_filter, nb_filter, nb_filter)
        
        self.conv0_5 = VGGBlock(nb_filter, nb_filter, nb_filter)
        self.conv1_5 = VGGBlock(nb_filter, nb_filter, nb_filter)
        
        self.conv0_6 = VGGBlock(nb_filter, nb_filter, nb_filter)
    ...
    def forward(self, input, orig_zoom):
        ...
        if self.deep_supervision:
            ...
            input = input[:,3]
            input = torch.unsqueeze(input,1)
            return (input-output), self.alpha_1, self.alpha_2, self.alpha_3, self.alpha_4, self.alpha_5, self.alpha_6
